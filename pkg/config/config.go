...
func InitDefaultConfig() {
	...
	// Database
	DatabaseType.setDefault("postgres")
	DatabaseHost.setDefault("172.20.112.1:5433")
	DatabaseUser.setDefault("postgres")
	DatabasePassword.setDefault("123")
	DatabaseDatabase.setDefault("vikunja_dev")
